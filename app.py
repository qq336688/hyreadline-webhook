...

{
  "qa_list": [
    {
      "q_text": "Q1：問題內容，保留具體細節（YYYY/MM/DD HH:MM 提問者姓名）",
      "a_text": "A：回答內容，保留具體細節（YYYY/MM/DD HH:MM 回答者姓名）",
      "category": "主分類名稱",
      "tags": ["標籤1", "標籤2", "標籤3"]
    }
  ],
...
- 若同一問題有多筆訊息（如檢測報告說明＋附件連結＋後續追問），a_text 要把關鍵資訊（案號、金額、連結）都合併保留，不可只挑一句代表全部
""" + tag_section + """
